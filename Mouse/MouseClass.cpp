...
bool MouseClass::EventBufferIsEmoty()
{
...
MouseEvent MouseClass::ReadEvent()
{
	...
	{
		MouseEvent e = this->eventBuffer.front(); //get first event
		this->eventBuffer.pop(); //discard event from buffer
		return e;
	}
}
